...
## Things I've Built
- [Tailwind.Standalone](https://github.com/marshalhayes/Tailwind.Standalone): A NuGet package that simplifies adding Tailwind CSS to .NET projects
...
While I was still at college, I interned at FedEx Express where I got my first taste of what it was like to work in the industry.
Soon after graduating from college, I began working at [MCR Safety](https://www.mcrsafety.com/about-mcr/). There, I worked on a small team of just two developers which consisted of myself and my manager (yes, really). I primarily worked on the company website, which was built on top of Sitecore and .NET at the time.
...
## Get in Touch
- [LinkedIn](https://www.linkedin.com/in/marshalhayes/)
- [Bluesky](https://bsky.app/profile/marshalhayes.dev)
